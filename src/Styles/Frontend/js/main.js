(function ($) {
  ...
  $(".navbar-brand-offer-menu .navbar-brand-offer-btn").click(function () {
    ...
    $(this)
      ...
      .next(".brand-category-list")
      .find(".navbar-brand-offer-list")
      .toggleClass("show");
  });
...
//  -------------- Multistep Form for business listing ----------------
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    document.getElementById("business_listing").submit();
    return false;
  }
...
//  -------------- Multistep Form for labour naka listing ----------------
...
function nextPrev1(n) {
  ...
  x1[currentTab1].style.display = "none";

  currentTab1 = currentTab1 + n;
  if (currentTab1 >= x1.length) {
    document.getElementById("labour_naka_listing").submit();
    return false;
  }
  showTab1(currentTab1);
}

//  -------------- Multistep Form for Buy listing ----------------
...
function nextPrev2(n) {
  ...
  if (currentTab2 >= x2.length) {
    document.getElementById("buy_listing").submit();
    return false;
  }
  showTab2(currentTab2);
}

//  -------------- Multistep Form for sell listing ----------------

var currentTab3 = 0;
// showTab1(currentTab2);

function showTab3(n) {
  var x3 = document.getElementsByClassName("tab3");
  x3[n].style.display = "block";
}

function nextPrev3(n) {
  var x3 = document.getElementsByClassName("tab3");
  x3[currentTab3].style.display = "none";

  currentTab3 = currentTab3 + n;
  if (currentTab3 >= x3.length) {
    document.getElementById("sell_listing").submit();
    return false;
  }
