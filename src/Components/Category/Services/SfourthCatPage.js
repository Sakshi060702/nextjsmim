...
const SfourthCatPage = ({ params }) => {
  console.log("Params in CthirdCatPage:", params);
  const { resolvedParams } = params || {};
  const { sSecCategory, sThirdCategory } = resolvedParams || {};
  ...
  console.log("cSecCategory:", sSecCategory);
  console.log("cThirdCategory:", sThirdCategory);
  ...
  }, [thirdCategoryId, sSecCategory, sThirdCategory]);
          ...
          <div className="row justify-content-center categories-list">
            ...
            >
              {fourthCategories.map((fourthCategory) => {
                const categoryUrl = `/All/${sSecCategory}/${sThirdCategory}/${encodeURIComponent(
                    ...
                    <div className="item">
                      ...
                      {fourthCategory.fifthCategories &&
                        fourthCategory.fifthCategories.length > 0 && (
                          <Link
                            href={{
                              pathname: `/Service/${sSecCategory}/${sThirdCategory}/${encodeURIComponent(
                                fourthCategory.name.replace(/ /g, "-")
                              )}`,
