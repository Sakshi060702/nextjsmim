...
const SthirdCatPage = ({ params }) => {
  ...
  const secCategory = decodeURIComponent(params?.sSecCategory);
                      ...
                      <div className="item">
                        ...
                        {subCategory.fourthCategories &&
                          subCategory.fourthCategories.length > 0 && (
                            <Link
                              href={{
                                pathname: `/Service/${decodeCateName}/${encodeURIComponent(
