...
const SSixthCatPage = ({ params }) => {
  ...
  const { sFifthCategory,sFourthCategory,sSecCategory,sThirdCategory } = resolvedParamsS||{} // Get dynamic route params
  ...
  console.log('fifthCategory',sFifthCategory)
  const decodeFifthcateogry=decodeURIComponent(sFifthCategory);
...
useEffect(() => {
  ...
  }, [fifthCategoryId,sFifthCategory,sFourthCategory,sSecCategory,sThirdCategory ]);
...
{
  const categoryUrl = `/All/${sSecCategory}/${sThirdCategory}/${sFourthCategory}/${sFifthCategory}/${encodeURIComponent(
