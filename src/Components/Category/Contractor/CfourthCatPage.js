...
const CfourthCatPage = ({ params }) => {
  console.log("Params in CthirdCatPage:", params);
  const { resolvedParams } = params || {};
  const { cSecCategory, cThirdCategory } = resolvedParams || {};
  ...
  console.log("cSecCategory:", cSecCategory);
  console.log("cThirdCategory:", cThirdCategory);
  ...
  }, [thirdCategoryId, cSecCategory, cThirdCategory]);
          ...
          <div className="row justify-content-center categories-list">
            ...
            >
              {fourthCategories.map((fourthCategory) => {
                const categoryUrl = `/All/${cSecCategory}/${cThirdCategory}/${encodeURIComponent(
                    ...
                    <div className="item">
                      ...
                      {fourthCategory.fifthCategories &&
                        fourthCategory.fifthCategories.length > 0 && (
                          <Link
                            href={{
                              pathname: `/Contractor/${cSecCategory}/${cThirdCategory}/${encodeURIComponent(
                                fourthCategory.name.replace(/ /g, "-")
                              )}`,
                              query: {
                                id: fourthCategory.fourthCategoryID,
                                secID: fourthCategory.secondCategoryID,
                              },
                            }}
                            title={fourthCategory.name}
                            style={{ color: "orange" }}
