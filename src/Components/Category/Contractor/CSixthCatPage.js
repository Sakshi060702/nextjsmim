...
const CSixthCatPage = ({ params }) => {
    const searchParams = useSearchParams();
    const id = searchParams.get("id");
    const secID = searchParams.get("secID");
  const { cFifthCategory,cFourthCategory,cThirdCategory,cSecCategory } = React.use(params); // Get dynamic route params
  ...
  console.log('fifthCategory',fifthCategory)
  const decodeFifthcateogry=decodeURIComponent(fifthCategory);
...
useEffect(() => {
  ...
  }, [fifthCategoryId,cFifthCategory,cFourthCategory,cThirdCategory,cSecCategory ]);
        ...
        <div className="row justify-content-center categories-list">
          <ul className="subcategories-list">
            {sixthCategories.map((sixthCategory) => {
              const categoryUrl = `/All/${cSecCategory}/${cThirdCategory}/${cFourthCategory}/${cFifthCategory}/${encodeURIComponent(
