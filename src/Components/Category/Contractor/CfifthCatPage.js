...
const CfifthCatPage = ({ params }) => {
  ...
  const { cSecCategory, cThirdCategory,cFourthCategory } = resolvedParamsF||{}
...
useEffect(() => {
  ...
  }, [fourthCategoryId,cFourthCategory,cThirdCategory,cSecCategory]);
      ...
      <div className="row justify-content-center categories-list">
        <ul className="subcategories-list d-flex justify-content-center flex-wrap">
          {fifthCategories.map((fifthCategory) => {
            const categoryUrl = `/All/${cSecCategory}/${cThirdCategory}/${cFourthCategory}/${encodeURIComponent(
  ...
  ></div>
                ...
                {fifthCategory.sixthCategories &&
                  fifthCategory.sixthCategories.length > 0 && (
                    <Link
                    href={{
                      pathname: `/Contractor/${cSecCategory}/${cThirdCategory}/${cFourthCategory}/${encodeURIComponent(fifthCategory.name.replace(/ /g, '-'))}`,
