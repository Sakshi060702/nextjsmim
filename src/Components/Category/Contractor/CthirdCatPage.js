...
const CthirdCatPage = ({ params }) => {
  ...
  const secCategory = decodeURIComponent(params?.cSecCategory);
                      ...
                      <div className="item">
                        ...
                        {subCategory.fourthCategories &&
                          subCategory.fourthCategories.length > 0 && (
                            <Link
                              href={{
                                pathname: `/Contractor/${decodeCateName}/${encodeURIComponent(
